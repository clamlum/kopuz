...
spotify_browser = Πρόγραμμα περιήγησης αναπαραγωγής Spotify
spotify_browser_auto = Αυτόματο
...
spotify_play_on = Αναπαραγωγή σε
spotify_this_app = kopuz (αυτή η εφαρμογή)
