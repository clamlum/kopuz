...
switch_to_local_library = Switch
add_local_library = Add Local Library
local_library_name = Library name
local_library_name_required = Library name is required
local_library_folder_required = Choose at least one folder
...
remote_music_folders = Music Folders
parent_folder = Up
use_this_folder = Add This Folder
no_subfolders = No subfolders
loading_folders = Loading folders…
folder_browse_failed = Could not list folders: { $error }
...
radio_starting = Starting radio…
radio_empty = No similar songs found
radio_failed = Couldn't start radio
...
tracing_warning = Adds runtime overhead and grows the trace file; takes effect after a restart.
...
lyrics_depth_blur_strength = Lyrics blur strength
