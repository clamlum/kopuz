...
add_local_library = ローカルライブラリを追加
local_library_name = ライブラリ名
local_library_name_required = ライブラリ名は必須です
local_library_folder_required = 1つ以上のフォルダを選択してください
service = サービス: { $name }
connected = ● 接続済み
disconnected = ● 未接続
connecting = ● 接続中…
...
remote_music_folders = 音楽フォルダ
parent_folder = 上へ
use_this_folder = このフォルダを追加
no_subfolders = サブフォルダがありません
loading_folders = フォルダを読み込み中…
folder_browse_failed = フォルダを一覧できませんでした: { $error }
add_server = サーバーを追加
connect_to_lastfm = Last.fm に接続
connect_to_librefm = Libre.fm に接続
lastfm_connected = Last.fm 接続済み
librefm_connected = Libre.fm 接続済み
...
cover_art_background = カバーアートを背景に表示
cover_art_darkening = カバーアートの暗さ
cover_art_blur = カバーアートのぼかし
custom_background = カスタム背景
choose_image = 画像を選択
custom_font = カスタムフォント
choose_font = フォントを選択
live_theme = Matugen / Pywal（ライブ）
live_theme_file = パレットファイル
choose_palette = パレットを選択
jump_to_current_song = 再生中の曲へ移動
hide_side_panel = サイドパネルを隠す
...
start_radio = ラジオを開始
radio_starting = ラジオを開始しています…
radio_empty = 類似する曲が見つかりません
radio_failed = ラジオを開始できませんでした
...
quick_search_placeholder = 入力して検索、Enterで再生…
...
close = 閉じる
mini_player = ミニプレーヤー
restore_full_player = フルプレーヤーに戻す
shuffle_on = シャッフル: オン
...
lastfm = Last.fm
librefm = Libre.fm
enable_tracing = パフォーマンストレースを有効化
tracing_warning = オーバーヘッドが増え、トレースファイルが大きくなります。再起動後に有効になります。
export_logs = ログをエクスポート
open_logs_folder = ログフォルダーを開く
english = English
russian = Русский
toki_pona = toki pona
turkish = Türkçe
...
lyrics_depth_blur_strength = 歌詞のぼかしの強さ
...
sort_then = 次に
sort_none = 並べ替えなし
sort_add_criterion = 条件を追加
sort_remove = 削除
sort_ascending = 昇順
sort_descending = 降順
sort_field_title = タイトル
sort_field_artist = アーティスト
sort_field_year = 年
sort_field_genre = ジャンル
sort_field_album = アルバム
sort_field_duration = 再生時間
sort_field_date_added = 追加日
sort_field_name = 名前
sort_field_tracks = トラック
sort_field_albums = アルバム
view_grid = グリッド表示
view_list = リスト表示
spotify_browser = Spotify再生ブラウザ
spotify_browser_auto = 自動
spotify_connect_device = Spotify の再生デバイス
spotify_connect_device_other = 他のデバイス
spotify_connect_device_this = このアプリ
