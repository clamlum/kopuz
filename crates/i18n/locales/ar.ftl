...
view_grid = عرض شبكي
view_list = عرض قائمة
spotify_browser = متصفح تشغيل Spotify
spotify_browser_auto = تلقائي
spotify_connect_device = جهاز تشغيل Spotify
spotify_connect_device_other = جهاز آخر
spotify_connect_device_this = هذا التطبيق
spotify_play_on = تشغيل على
spotify_this_app = kopuz (هذا التطبيق)
