...
activity = Активность
general = Общие
local_libraries = Локальные медиатеки
active_local_library = Активна
switch_to_local_library = Переключить
add_local_library = Добавить локальную медиатеку
local_library_name = Название медиатеки
local_library_name_required = Необходимо указать название медиатеки
local_library_folder_required = Выберите хотя бы одну папку
service = Служба: { $name }
...
remote_music_folders = Папки с музыкой
parent_folder = Вверх
use_this_folder = Добавить эту папку
no_subfolders = Нет вложенных папок
loading_folders = Загрузка папок…
folder_browse_failed = Не удалось получить список папок: { $error }
...
fullscreen_use_player_bar = Использовать панель плеера как управление в полноэкранном режиме
cover_art_background = Обложка в качестве фона
cover_art_darkening = Затемнение обложки
cover_art_blur = Размытие обложки
custom_background = Пользовательский фон
choose_image = Выбрать изображение
custom_font = Пользовательский шрифт
choose_font = Выбрать шрифт
live_theme = Matugen / Pywal (живая)
live_theme_file = Файл палитры
choose_palette = Выбрать палитру
jump_to_current_song = Перейти к текущей песне
...
show_row_images = Показывать изображения в строках
...
radio_starting = Запуск радио…
radio_empty = Похожие треки не найдены
radio_failed = Не удалось запустить радио
...
instrumental_break = Инструментал
...
quick_search_placeholder = Введите для поиска, Enter для воспроизведения…
...
lyrics_depth_blur = Размывать строки текста в зависимости от расстояния до активной строки
lyrics_depth_blur_strength = Сила размытия текста
...
sort_field_album = Альбом
sort_field_duration = Длительность
sort_field_date_added = Дата добавления
sort_field_name = Имя
sort_field_tracks = Треки
...
spotify_connect_device = Устройство воспроизведения Spotify
spotify_connect_device_other = Другое устройство
spotify_connect_device_this = Это приложение
spotify_play_on = Воспроизвести на
spotify_this_app = kopuz (это приложение)
settings_managed_notice = Некоторые настройки управляются конфигурацией системы (Nix/hjem) и не могут быть изменены здесь.
setting_managed_by_system = Управляется конфигурацией системы
