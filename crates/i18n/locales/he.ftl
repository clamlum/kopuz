...
spotify_browser = דפדפן ההשמעה של Spotify
spotify_browser_auto = אוטומטי
spotify_connect_device = מכשיר ההשמעה של Spotify
spotify_connect_device_other = מכשיר אחר
spotify_connect_device_this = היישום הזה
spotify_play_on = השמעה במכשיר
spotify_this_app = kopuz (האפליקציה הזו)
