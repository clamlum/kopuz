...
add_local_library = Додати локальну медіатеку
local_library_name = Назва медіатеки
local_library_name_required = Потрібно вказати назву медіатеки
local_library_folder_required = Виберіть принаймні одну папку
service = Сервіс: { $name }
...
remote_music_folders = Папки з музикою
parent_folder = Вгору
use_this_folder = Додати цю папку
no_subfolders = Немає вкладених папок
loading_folders = Завантаження папок…
folder_browse_failed = Не вдалося отримати список папок: { $error }
...
choose_font = Вибрати шрифт
live_theme = Matugen / Pywal (жива)
live_theme_file = Файл палітри
choose_palette = Вибрати палітру
...
radio_starting = Запуск радіо…
radio_empty = Схожих треків не знайдено
radio_failed = Не вдалося запустити радіо
...
restore_full_player = Відновити повний плеєр
...
radio_loading_stations = Завантаження станцій…
radio_search_failed = Не вдалося зв'язатися з radio-browser.info
...
minimize_to_tray = Згорнути в системний лоток
...
sort_then = потім
sort_none = Без сортування
sort_add_criterion = Додати критерій
sort_remove = Видалити
sort_ascending = За зростанням
sort_descending = За спаданням
sort_field_title = Назва
sort_field_artist = Виконавець
sort_field_year = Рік
sort_field_genre = Жанр
sort_field_album = Альбом
sort_field_duration = Тривалість
sort_field_date_added = Дата додавання
sort_field_name = Ім'я
sort_field_tracks = Треки
sort_field_albums = Альбоми
view_grid = Вигляд сіткою
view_list = Вигляд списком
spotify_browser = Браузер відтворення Spotify
spotify_browser_auto = Автоматично
spotify_connect_device = Пристрій відтворення Spotify
spotify_connect_device_other = Інший пристрій
spotify_connect_device_this = Цей застосунок
spotify_play_on = Відтворити на
spotify_this_app = kopuz (цей застосунок)
settings_managed_notice = Деякі налаштування керуються конфігурацією системи (Nix/hjem) і не можуть бути змінені тут.
setting_managed_by_system = Керується конфігурацією системи
